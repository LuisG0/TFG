...
from transformerModels.utils import PositionalEncoding, generate_square_subsequent_mask, _get_subsequent_mask
...
class TransformerSpatioTemporalModel(pl.LightningModule):
    ...
    def forward(self, src,trg):
        ...
        if self.trg_mask is None or self.trg_mask.size(0) != trg.shape[1]:
